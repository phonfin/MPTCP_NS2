...
set Buffer_Ratio [lindex $argv 3];
set Buffer_Ratio [expr $Buffer_Ratio];
...
#set B [expr 100*(1-$Buffer_Ratio/8)+50];
set B [expr 40+20*$Buffer_Ratio];
set K 65;
set RTT 0.0001;
...
##--------special path----------
$ns simplex-link $s_tor $n([expr $PATH-1]) $lineRate [expr $RTT/8] DropTail;
$ns simplex-link $n([expr $PATH-1]) $s_tor $lineRate [expr $RTT/8] DropTail;

$ns simplex-link $n([expr $PATH-1]) $r_tor $lineRate [expr $RTT/8] DropTail;
