...
set BW_Ratio [lindex $argv 3];
set BW_Ratio [expr $BW_Ratio];
...
set inputRate 1.0Gb
set lineRate 1.0Gb
set bnkRate [expr 1000000000/$BW_Ratio];
set packetSize 1460
...
##--------special path----------
$ns simplex-link $s_tor $n([expr $PATH-1]) $bnkRate [expr $RTT/8] DropTail;
$ns simplex-link $n([expr $PATH-1]) $s_tor $lineRate [expr $RTT/8] DropTail;

$ns simplex-link $n([expr $PATH-1]) $r_tor $bnkRate [expr $RTT/8] DropTail;
